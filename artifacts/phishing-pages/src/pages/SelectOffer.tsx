...
const DEFAULT_COMPANY_SETTINGS: CompanySettings = {
  offers: [
    ...
    { id: "bupa", name: "بوبا العربية", price: 710.0, type: "ضد الغير", active: true },
    { id: "sgi", name: "اس جي اي", price: 725.0, type: "ضد الغير", active: true },
    { id: "gulf_union", name: "اتحاد الخليج", price: 745.0, type: "ضد الغير", active: true },
    { id: "al_jazira", name: "الجزيرة تكافل", price: 765.0, type: "ضد الغير", active: true },
    // شامل
    ...
    { id: "bupa_2", name: "بوبا العربية", price: 1775.0, type: "شامل", active: true },
    { id: "sgi_2", name: "اس جي اي", price: 1825.0, type: "شامل", active: true },
    { id: "gulf_union_2", name: "اتحاد الخليج", price: 1875.0, type: "شامل", active: true },
    { id: "al_jazira_2", name: "الجزيرة تكافل", price: 1925.0, type: "شامل", active: true },
  ],
};
