        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 max-w-2xl mx-auto overflow-hidden">
          ...
          {activeTab !== "مركبات" ? (
            ...
            <div className="p-5 md:p-7">
              ...
              {/* نقل ملكية - استمارة / بطاقة جمركية */}
              {formType === "نقل ملكية" && (
                <div className="flex flex-col gap-2 mb-6">
                  <button onClick={() => setSubFormType("استمارة")}
                    className={`w-full py-4 px-6 text-base font-bold rounded-xl border-2 transition-all ${subFormType === "استمارة" ? "bg-primary text-white border-primary" : "bg-white text-gray-700 border-gray-200 hover:border-primary"}`}>
                    استمارة
                  </button>
                  <button onClick={() => setSubFormType("بطاقة جمركية")}
                    className={`w-full py-4 px-6 text-base font-bold rounded-xl border-2 transition-all ${subFormType === "بطاقة جمركية" ? "bg-primary text-white border-primary" : "bg-white text-gray-700 border-gray-200 hover:border-primary"}`}>
                    بطاقة جمركية
                  </button>
